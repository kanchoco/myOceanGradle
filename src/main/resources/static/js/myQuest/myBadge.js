...
let text = '';
    ...
    text += `<strong class="BottomSheet__Title-e2nchk-5 oFqnL">회원가입 축하 뱃지</strong>`
    text += `</div>`
    ...
    text += `<strong class="MonthlyChallenge__BadgeTitle-sc-10xmpdd-2 jZwSMv">회원가입 축하 뱃지</strong>`
    text += `<p class="MonthlyChallenge__BadgeDescription-sc-10xmpdd-3 bOPHSQ">회원가입 시 제공되는 뱃지입니다.</p>`
