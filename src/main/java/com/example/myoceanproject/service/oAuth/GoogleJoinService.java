...
public class GoogleJoinService {
    ...
    public int getGoogleAccessTokenInfo(String authCode) throws Exception{
        ...
        try {
            ...
            googleOAuthRequestParam.setRedirectUri("http://localhost:15000/join/googleJoin");
            ...
            if(users.size()<1){
                ...
                user.setUserLoginMethod(UserLoginMethod.GOOGLE);
