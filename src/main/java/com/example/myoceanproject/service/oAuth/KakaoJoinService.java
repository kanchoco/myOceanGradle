...
public class KakaoJoinService {
    ...
    public String getKaKaoAccessToken(String code){
        ...
        try{
            ...
            sb.append("&redirect_uri=http://localhost:15000/join/kakaoJoin"); // TODO 인가코드 받은 redirect_uri 입력
            sb.append("&code=" + code);
    ...
    public int getKakaoInfo(String token) throws Exception {
        ...
        try {
            ...
            if(users.size()<1 && email!="secureLevelTwo"){
                ...
                user.setUserLoginMethod(UserLoginMethod.KAKAO);
                user.updateNicknameFile(userDTO);
                userRepository.save(user);
            }

            br.close();
            if(email.equals("secureLevelTwo")){
                return 2;
            }else if(!email.equals("secureLevelTwo") && users.size()==1){
                return 1;
            }else{
                return 0;
            }
